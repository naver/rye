...
extern int css_send_data_packet (CSS_CONN_ENTRY * conn, unsigned short rid,
				 int num_buffers, ...);
extern int css_send_data_packet_v (CSS_CONN_ENTRY * conn, unsigned short rid,
...
extern int css_send_error_packet (CSS_CONN_ENTRY * conn, unsigned short rid,
...
extern char *css_net_packet_get_buffer (CSS_NET_PACKET * net_packet,
					int index, int expected_size,
					bool reset_ptr);
extern int css_net_packet_get_recv_size (CSS_NET_PACKET * net_packet,
					 int index);
...
extern void css_register_server_timeout_fn (CSS_SERVER_TIMEOUT_FN
					    callback_fn);
extern void css_register_check_server_alive_fn (CSS_CHECK_SERVER_ALIVE_FN
						callback_fn);
extern void css_register_check_client_alive_fn (CSS_CHECK_CLIENT_ALIVE_FN
						callback_fn);
#endif /* !SERVER_MODE */
