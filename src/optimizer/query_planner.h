...
struct qo_plan
{
  ...
  /* cost which are fixed against join position(inner or outer) */
  double fix_cost;
  /* cost which are variable according to join position */
  double var_cost;
...
struct qo_planner
{
  ...
  /*
   * The path segments involved in the various join terms
   */
  QO_SEGMENT *segment;
