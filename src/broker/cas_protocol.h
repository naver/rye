...
#define DRIVER_SHARD_INFO_SYNC_INTERVAL_SEC	10
  ...
  typedef enum
  {
    ...
    BRREQ_OP_CODE_CONNECT_DB_SERVER = 26,
    BRREQ_OP_CODE_PING = 27,
    BRREQ_OP_CODE_RM_TMP_FILE = 28,

    BRREQ_OP_CODE_LOCAL_MMGT_MIN = BRREQ_OP_CODE_SYNC_SHARD_MGMT_INFO,
    BRREQ_OP_CODE_LOCAL_MGMT_MAX = BRREQ_OP_CODE_RM_TMP_FILE,
    ...
    BRREQ_OP_CODE_PING_SHARD_MGMT = 76,

    BRREQ_OP_CODE_SHARD_MGMT_MIN = BRREQ_OP_CODE_GET_SHARD_INFO,
    BRREQ_OP_CODE_SHARD_MGMT_MAX = BRREQ_OP_CODE_PING_SHARD_MGMT
  } T_BRREQ_OP_CODE;
...
#define MGMT_LUANCH_IS_FLAG_SET(x,flag)		((x) & (flag))
  typedef enum
  {
    MGMT_LAUNCH_FLAG_NO_FLAG = 0,
    MGMT_LAUNCH_FLAG_NO_RESULT = 1
  } T_MGMT_LAUNCH_FLAG;
  typedef enum
  {
    MGMT_REQ_ARG_INT = 1,
