...
extern int ux_database_connect (const char *db_name, const char *db_user,
...
extern int ux_execute (T_SRV_HANDLE * srv_handle, char flag, int max_col_size,
		       int max_row, int argc, void **argv, int group_id,
		       T_NET_BUF *, T_REQ_INFO * req_info);
extern int ux_fetch (T_SRV_HANDLE * srv_handle, int cursor_pos,
		     int fetch_count, int result_set_index,
