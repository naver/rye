...
extern void sheap_create (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
extern void sheap_destroy (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
...
extern void sboot_find_number_bestspace_entries (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
extern void sboot_get_server_state (THREAD_ENTRY * thread_p, unsigned int rid, char *request, UNUSED_ARG int reqlen);
extern void sboot_notify_ha_apply_state (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
...
extern void sbtree_load_data (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
...
extern void sqmgr_drop_query_plan (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
...
extern void sct_can_accept_new_repr (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
extern int xs_receive_data_from_client (THREAD_ENTRY * thread_p, char **area, int *datasize, int timeout);
#if defined (ENABLE_UNUSED_FUNCTION)
...
extern void sserver_stats_dump (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
...
extern int xlog_send_log_pages_to_migrator (THREAD_ENTRY * thread_p, char *logpg_area, int area_size);
extern int xlog_get_page_request_with_reply (THREAD_ENTRY * thread_p, LOG_PAGEID * fpageid_ptr);
extern void sheap_get_class_num_objs_and_pages (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
...
extern void srepl_log_get_eof_lsa (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
...
extern void slocator_lock_system_ddl_lock (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
#if defined (ENABLE_UNUSED_FUNCTION)
extern void slock_change_class_xlock_to_ulock (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
#endif
extern void smigrator_get_log_pages (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
extern void slogtb_update_group_id (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
extern void slogtb_block_global_dml (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
extern void sbk_prepare_backup (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
extern void sbk_backup_volume (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
extern void sbk_backup_log_volume (THREAD_ENTRY * thread_p, unsigned int rid, char *request, int reqlen);
