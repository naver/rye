...
/*
 * Message set id in the message catalog MSGCAT_CATALOG_RYE.
...
#define MSGCAT_SEMANTIC_ALTER_ADD_PRIMARY_KEY           MSGCAT_SEMANTIC_NO(220)
...
#define MSGCAT_SEMANTIC_WRONG_SHARDKEY_POSITION_IN_PK      MSGCAT_SEMANTIC_NO(288)
#define MSGCAT_SEMANTIC_WRONG_SHARDKEY_TYPE		MSGCAT_SEMANTIC_NO(289)
#define MSGCAT_SEMANTIC_CANT_UPDATE_SHARDKEY		MSGCAT_SEMANTIC_NO(290)
...
#define MSGCAT_RUNTIME_BAD_DATETIME		        MSGCAT_RUNTIME_NO(66)
