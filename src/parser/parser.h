...
extern "C"
{
  ...
  extern PARSER_VARCHAR *pt_append_bytes (const PARSER_CONTEXT * parser,
                                          PARSER_VARCHAR * old_bytes, const char *new_tail, const int length);
  extern PARSER_VARCHAR *pt_append_varchar (const PARSER_CONTEXT * parser,
                                            PARSER_VARCHAR * old_bytes, const PARSER_VARCHAR * new_tail);
  extern PARSER_VARCHAR *pt_append_nulstring (const PARSER_CONTEXT * parser,
                                              PARSER_VARCHAR * old_bytes, const char *new_tail);
  ...
  extern void pt_record_error (PARSER_CONTEXT * parser, int line_no, int col_no, const char *msg, const char *context);
  ...
  extern void pt_end_query (PARSER_CONTEXT * parser, QUERY_ID query_id_self, PT_NODE * statement);
  ...
  extern DB_VALUE *pt_db_value_initialize (PARSER_CONTEXT * parser,
                                           PT_NODE * value, DB_VALUE * db_value, int *more_type_info_needed);

  extern PT_NODE *pt_spec_to_oid_attr (PARSER_CONTEXT * parser, PT_NODE * spec);
  ...
  extern DB_VALUE *pt_seq_value_to_db (PARSER_CONTEXT * parser,
                                       PT_NODE * values, DB_VALUE * db_value, PT_NODE ** el_types);
  ...
  extern int pt_coerce_value (PARSER_CONTEXT * parser,
                              PT_NODE * src, PT_NODE * dest, PT_TYPE_ENUM desired_type, PT_NODE * elem_type_list);

  extern PT_NODE *pt_bind_type_from_dbval (PARSER_CONTEXT * parser, PT_NODE * node, DB_VALUE * val);
  ...
  extern int pt_comp_to_between_op (PT_OP_TYPE left, PT_OP_TYPE right,
                                    PT_COMP_TO_BETWEEN_OP_CODE_TYPE code, PT_OP_TYPE * between);
#if defined (ENABLE_UNUSED_FUNCTION)
  extern int pt_between_to_comp_op (PT_OP_TYPE between, PT_OP_TYPE * left, PT_OP_TYPE * right);
#endif

  extern int pt_evaluate_def_val (PARSER_CONTEXT * parser, PT_NODE * tree, DB_VALUE * db_values);
#if defined(ENABLE_UNUSED_FUNCTION)
  ...
  extern int pt_evaluate_function_w_args (PARSER_CONTEXT * parser,
                                          FUNC_TYPE fcode, DB_VALUE * args[], const int num_args, DB_VALUE * result);
  ...
  extern PT_NODE *mq_regenerate_if_ambiguous (PARSER_CONTEXT * parser,
                                              PT_NODE * spec, PT_NODE * statement, PT_NODE * from);
  ...
  extern void pt_report_to_ersys_with_statement (PARSER_CONTEXT * parser,
                                                 const PT_ERROR_TYPE error_type, PT_NODE * statement);
#if defined (ENABLE_UNUSED_FUNCTION)
  ...
  extern PT_NODE *pt_entity (PARSER_CONTEXT * parser,
                             const PT_NODE * entity_name, const PT_NODE * range_var, const PT_NODE * flat_list);
  ...
  extern PT_NODE *pt_is_inst_or_orderby_num_node_post (PARSER_CONTEXT *
                                                       parser, PT_NODE * tree, void *arg, int *continue_walk);
#endif
  ...
  extern void pt_record_warning (PARSER_CONTEXT * parser, int line_no, int col_no, const char *msg);
#if 0                           /* unused */
  extern PT_NODE *pt_get_warnings (const PARSER_CONTEXT * parser);
#endif
  extern PT_NODE *pt_get_errors (PARSER_CONTEXT * parser);

  extern PT_NODE *pt_get_next_error (PT_NODE * errors, int *line_no, int *col_no, const char **msg);
  ...
  extern bool pt_sort_spec_cover_groupby (PARSER_CONTEXT * parser,
                                          PT_NODE * sort_list, PT_NODE * group_list, PT_NODE * tree);
  ...
  extern PT_NODE *pt_limit_to_numbering_expr (PARSER_CONTEXT * parser,
                                              PT_NODE * limit, PT_OP_TYPE num_op, bool is_gby_num);
  ...
  extern int pt_node_list_to_array (PARSER_CONTEXT * parser,
                                    PT_NODE * arg_list, PT_NODE * arg_array[], const int array_size, int *num_args);
  ...
  extern PT_NODE *parser_make_expression (PARSER_CONTEXT * parser,
                                          PT_OP_TYPE OP, PT_NODE * arg1, PT_NODE * arg2, PT_NODE * arg3);
  ...
  extern PT_NODE *pt_convert_to_logical_expr (PARSER_CONTEXT * parser,
                                              PT_NODE * node, bool use_parens_inside, bool use_parens_outside);
  ...
  extern int pt_mark_spec_list_for_update (PARSER_CONTEXT * parser, PT_NODE * statement);
  extern int pt_mark_spec_list_for_delete (PARSER_CONTEXT * parser, PT_NODE * delete_statement);
  extern void pt_init_assignments_helper (PARSER_CONTEXT * parser,
                                          PT_ASSIGNMENTS_HELPER * helper, PT_NODE * assignment);
  ...
  extern int pt_get_assignment_lists (PARSER_CONTEXT * parser,
                                      ...
                                      PT_NODE ** select_values, int *no_vals, PT_NODE * assign, PT_NODE *** old_links);

  extern PT_NODE *pt_sort_spec_list_to_name_node_list (PARSER_CONTEXT * parser, PT_NODE * sort_spec_list);

  extern int pt_check_grammar_charset_collation (PARSER_CONTEXT * parser, PT_NODE * coll_node, int *coll_id);
  ...
  extern PT_NODE *pt_make_query_explain (PARSER_CONTEXT * parser, PT_NODE * statement);
  extern PT_NODE *pt_make_query_show_trace (PARSER_CONTEXT * parser);

  extern void insert_check_names_in_value_clauses (PARSER_CONTEXT * parser, PT_NODE * insert_statement);
