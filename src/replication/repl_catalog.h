...
extern int rpct_get_log_writer (CIRP_CT_LOG_WRITER * ct_data,
				CCI_CONN * conn, const char *host_ip);
...
extern int rpct_init_applier_info (CCI_CONN * conn, const char *host_ip,
				   INT64 current_time_in_msec);
