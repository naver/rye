...
/*
 * locator_unpack_lockset_header : Unpack the lockset area header
 *
 * return:
 *
 *   unpacked(in):
...
/*
 * locator_unpack_lockset_classes : Pack the lockset area classes
 *
 * return:
 *
 *   unpacked(in):
...
/*
 * locator_unpack_lockset_objects : Unpack the lockset area objects
 *
 * return:
 *
 *   unpacked(in):
...
locator_make_oid_set (void)
{
  ...
  set = (LC_OIDSET *) malloc (sizeof (LC_OIDSET));
  if (set == NULL)
    {
      return NULL;
    }
 ...
 */
void
locator_clear_oid_set (UNUSED_ARG THREAD_ENTRY * thread_p, LC_OIDSET * oidset)
{
...
/*
 * locator_unpack_oid_set_to_exist () -
 *
