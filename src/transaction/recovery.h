...
typedef enum
{
  ...
  RVBT_NEW_PGALLOC = 66,
  RVBT_KEYVAL_INSERT = 67,
  RVBT_KEYVAL_DELETE = 68,
  RVBT_COPYPAGE = 69,
  RVBT_NOOP = 70,
  RVBT_INS_PGRECORDS = 71,
  RVBT_CREATE_INDEX = 72,

  RVCT_NEWPAGE = 73,
  RVCT_INSERT = 74,
  RVCT_DELETE = 75,
  RVCT_UPDATE = 76,
  RVCT_NEW_OVFPAGE_LOGICAL_UNDO = 77,

  RVLOG_OUTSIDE_LOGICAL_REDO_NOOP = 78,

  RVREPL_DATA_INSERT = 79,
  RVREPL_DATA_UPDATE = 80,
  RVREPL_DATA_DELETE = 81,
  RVREPL_SCHEMA = 82,

  RVDK_IDDEALLOC_BITMAP_ONLY = 83,
  RVDK_IDDEALLOC_VHDR_ONLY = 84,
