...
extern int session_state_destroy (THREAD_ENTRY * thread_p, const SESSION_KEY * key);
extern int session_check_session (THREAD_ENTRY * thread_p, const SESSION_KEY * key);
extern int session_set_session_key (THREAD_ENTRY * thread_p, const SESSION_KEY * key);
extern int session_remove_expired_sessions (struct timeval *timeout);
#if !defined(SERVER_MODE)
extern int session_get_session_id (THREAD_ENTRY * thread_p, SESSION_KEY * key);
#endif
