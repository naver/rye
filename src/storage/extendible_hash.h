...
extern EH_SEARCH ehash_search (THREAD_ENTRY * thread_p, const EHID * ehid, const void *key, OID * value_ptr);
...
extern void ehash_dump (THREAD_ENTRY * thread_p, FILE * out_fp, EHID * ehid);
#if defined (ENABLE_UNUSED_FUNCTION)
