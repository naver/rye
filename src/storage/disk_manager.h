...
extern bool disk_goodvol_refresh (THREAD_ENTRY * thread_p, int hint_max_nvols);
...
extern INT32 disk_alloc_page (THREAD_ENTRY * thread_p, INT16 volid,
                              INT32 sectid, INT32 npages, INT32 near_pageid, DISK_PAGE_TYPE alloc_page_type);
...
extern int disk_dealloc_page (THREAD_ENTRY * thread_p, INT16 volid,
                              INT32 pageid, INT32 npages, DISK_PAGE_TYPE page_type);
...
extern int disk_set_creation (THREAD_ENTRY * thread_p, INT16 volid,
                              ...
                              const LOG_LSA * new_chkptlsa, bool logchange, DISK_FLUSH_TYPE flush_page);
#endif
...
extern int disk_set_boot_hfid (THREAD_ENTRY * thread_p, const HFID * hfid);
...
extern INT16 disk_get_first_total_free_numpages (THREAD_ENTRY * thread_p,
                                                 DISK_VOLPURPOSE purpose, INT32 * ntotal_pages, INT32 * nfree_pgs);
#endif /* ENABLE_UNUSED_FUNCTION */
extern INT16 xdisk_get_purpose_and_sys_lastpage (THREAD_ENTRY * thread_p,
                                                 INT16 volid, DISK_VOLPURPOSE * vol_purpose, INT32 * sys_lastpage);
...
extern HFID *disk_get_boot_hfid (THREAD_ENTRY * thread_p, HFID * hfid);
extern char *disk_get_link (THREAD_ENTRY * thread_p, const char *db_fullname, INT16 volid, char *next_volext_fullname);
...
extern SCAN_CODE disk_volume_header_next_scan (THREAD_ENTRY * thread_p,
                                               int cursor, DB_VALUE ** out_values, int out_cnt, void *ctx);
#endif /* ENABLE_UNUSED_FUNCTION */
...
extern int disk_vhdr_rv_undoredo_free_pages (THREAD_ENTRY * thread_p, LOG_RCV * rcv);
extern void disk_vhdr_rv_dump_free_pages (FILE * fp, int length_ignore, void *data);
