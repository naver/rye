...
extern FILE_IS_NEW_FILE file_is_new_file_with_has_undolog (THREAD_ENTRY *
                                                           thread_p, const VFID * vfid, bool * has_undolog);
...
extern int file_create_hint_numpages (THREAD_ENTRY * thread_p, INT32 exp_numpages, const FILE_TYPE file_type);
...
#endif
#if defined (ENABLE_UNUSED_FUNCTION)
extern int file_compress_all (THREAD_ENTRY * thread_p);
#endif
...
extern int file_find_page (THREAD_ENTRY * thread_p, const VFID * vfid, const VPID * vpid);
...
extern bool file_tracker_is_registered_vfid (THREAD_ENTRY * thread_p, const VFID * vfid);
