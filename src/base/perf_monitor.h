...
typedef enum
{
  ...
  MNT_STATS_DATA_PAGE_FETCHES_OP_FILE_ALLOC_PAGES,	/* 15 */
  MNT_STATS_DATA_PAGE_FETCHES_OP_FILE_DEALLOC_PAGE,	/* 16 */
  MNT_STATS_DATA_PAGE_FETCHES_OP_HEAP_FIND_BEST_PAGE,	/* 17 */
  MNT_STATS_DATA_PAGE_FETCHES_OP_HEAP_BESTSPACE_SYNC,	/* 18 */
  MNT_STATS_DATA_PAGE_FETCHES_OP_HEAP_OVF_INSERT,	/* 19 */
  MNT_STATS_DATA_PAGE_FETCHES_OP_HEAP_OVF_UPDATE,	/* 20 */
#if 0
  MNT_STATS_DATA_PAGE_FETCHES_OP_21,	/* reserve 21~24 */
  MNT_STATS_DATA_PAGE_FETCHES_OP_22,	/* reserve 21~24 */
  MNT_STATS_DATA_PAGE_FETCHES_OP_23,	/* reserve 21~24 */
  MNT_STATS_DATA_PAGE_FETCHES_OP_24,	/* reserve 21~24 */
#endif
#endif
