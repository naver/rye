...
extern "C"
{
  ...
  extern int intl_char_count (unsigned char *src, int length_in_bytes, int *char_count);
  extern int intl_char_size (unsigned char *src, int length_in_chars, int *byte_count);
  extern unsigned char *intl_prev_char (unsigned char *s, const unsigned char *s_start, int *prev_char_size);
  extern unsigned char *intl_next_char (unsigned char *s, int *current_char_size);
  extern int intl_cmp_char (const unsigned char *s1, const unsigned char *s2, int *char_size);
  ...
  extern bool intl_is_space (const char *str, const char *str_end, int *space_size);
  extern const char *intl_skip_spaces (const char *str, const char *str_end);
  extern const char *intl_backskip_spaces (const char *str_begin, const char *str_end);
  ...
  extern unsigned int intl_dbcs_to_cp (const unsigned char *seq,
                                       const int size, const unsigned char *byte_flag, unsigned char **next_char);
  ...
  extern int intl_text_single_byte_to_utf8_ext (void *txt_conv,
                                                const char *in_buf, const int in_size, char **out_buf, int *out_size);
  ...
  extern int intl_text_dbcs_to_utf8_ext (void *t, const char *in_buf, const int in_size, char **out_buf, int *out_size);
  ...
  extern int intl_fast_iso88591_to_utf8 (const unsigned char *in_buf,
                                         const int in_size, unsigned char **out_buf, int *out_size);
