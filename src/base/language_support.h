...
extern "C"
{
...
#endif
  extern const LANG_LOCALE_DATA *lang_get_specific_locale (const INTL_LANG lang);
  ...
  extern const char *lang_date_format_parse (const INTL_LANG lang_id, const DB_TYPE type);
