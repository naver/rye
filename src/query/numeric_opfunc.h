...
extern int numeric_coerce_string_to_num (const char *astring, int astring_len, DB_VALUE * num);

extern int numeric_coerce_num_to_num (DB_C_NUMERIC src_num,
                                      int src_prec,
                                      int src_scale, int dest_prec, int dest_scale, DB_C_NUMERIC dest_num);
