...
extern int qdata_add_dbval (DB_VALUE * dbval1_p, DB_VALUE * dbval2_p,
			    DB_VALUE * result_p);
...
extern int qdata_strcat_dbval (DB_VALUE * dbval1,
			       DB_VALUE * dbval2, DB_VALUE * res);
extern int qdata_extract_dbval (const MISC_OPERAND extr_operand,
				DB_VALUE * dbval, DB_VALUE * res);
extern int qdata_add_chars_to_dbval (DB_VALUE * dbval1_p, DB_VALUE * dbval2_p,
				     DB_VALUE * result_p);
extern int qdata_coerce_dbval_to_numeric (DB_VALUE * dbval_p,
					  DB_VALUE * result_p);
