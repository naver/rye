...
//  TP_DOMAIN tmp_arg1_domain, tmp_arg2_domain;
  ...
  switch (arithptr->opcode)
      ...
      if (arithptr->opcode == T_SUBSTRING && arithptr->thirdptr == NULL)
	{
      ...
      if (fetch_peek_dbval (thread_p, arithptr->thirdptr,
			    vd, obj_oid, tpl, &peek_third) != NO_ERROR)
	{
	  goto error;
	}
      break;
    ...
    case T_FROM_UNIXTIME:
      ...
      if (fetch_peek_dbval (thread_p, arithptr->leftptr, vd, obj_oid,
	...
	{
	  if (fetch_peek_dbval (thread_p, arithptr->rightptr, vd,
	...
	{
	  if (fetch_peek_dbval (thread_p, arithptr->thirdptr, vd,
    ...
    case T_MAKETIME:
	  ...
	  || fetch_peek_dbval (thread_p, arithptr->rightptr,
			       vd, obj_oid, tpl, &peek_right) != NO_ERROR
	  || fetch_peek_dbval (thread_p, arithptr->thirdptr,
			       vd, obj_oid, tpl, &peek_third) != NO_ERROR)
	{
	  goto error;
	}
	  ...
	  NO_ERROR)
	{
      ...
      if (fetch_peek_dbval (thread_p, arithptr->thirdptr,
			    vd, obj_oid, tpl, &peek_fourth) != NO_ERROR)
	{
	  goto error;
	}
      break;
  ...
  switch (arithptr->opcode)
    ...
    case T_ADD:
      {
	if (qdata_add_dbval (peek_left, peek_right, arithptr->value) !=
	    NO_ERROR)
	  {
	    goto error;
	  }
    ...
    case T_LN:
      if (db_log_generic_dbval (arithptr->value, peek_right,
    ...
    case T_INSTR:
      if (db_string_instr (peek_left, peek_right, peek_third,
			   arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_FINDINSET:
      if (db_find_string_in_in_set (peek_left, peek_right,
				    arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
	...
	{
	  peek_right =
	    db_value_cast_arg (peek_right, &tmp_right, DB_TYPE_VARCHAR,
			       &error_status);
      ...
      else
	{
	  ...
	  peek_right =
	    db_value_cast_arg (peek_right, &tmp_right, DB_TYPE_VARBIT,
			       &error_status);
    ...
    case T_BIN:
      if (db_bigint_to_binary_string (peek_right, arithptr->value)
	  != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_SHA_TWO:
      if (db_string_sha_two (peek_left, peek_right,
			     arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_TRIM:
      if (db_string_trim (arithptr->misc_operand,
			  peek_right, peek_left, arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
      break;
    ...
    case T_FROM_UNIXTIME:
      if (db_from_unixtime (peek_left, peek_right, peek_third,
			    arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_LPAD:
      if (db_string_pad (LEADING, peek_left, peek_right, peek_third,
			 arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_RPAD:
      if (db_string_pad (TRAILING, peek_left, peek_right, peek_third,
			 arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_REPLACE:
      if (db_string_replace (peek_left, peek_right, peek_third,
			     arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_TRANSLATE:
      if (db_string_translate (peek_left, peek_right, peek_third,
			       arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_TIME_FORMAT:
      if (db_time_format (peek_left, peek_right, peek_third,
			  arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_YEAR:
      if (db_get_date_item (peek_right, PT_YEARF,
			    arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_MONTH:
      if (db_get_date_item (peek_right, PT_MONTHF,
			    arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_HOUR:
      if (db_get_time_item (peek_right, PT_HOURF,
			    arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_MINUTE:
      if (db_get_time_item (peek_right, PT_MINUTEF,
			    arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_SECOND:
      if (db_get_time_item (peek_right, PT_SECONDF,
			    arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_WEEKDAY:
      if (db_get_date_weekday (peek_right, PT_WEEKDAY,
			       arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_DAYOFWEEK:
      if (db_get_date_weekday (peek_right, PT_DAYOFWEEK,
			       arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_MONTHS_BETWEEN:
      if (db_months_between (peek_left, peek_right,
			     arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_FORMAT:
      if (db_format (peek_left, peek_right, peek_third, arithptr->value) !=
	  NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_DATE_FORMAT:
      if (db_date_format (peek_left, peek_right, peek_third,
			  arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_STR_TO_DATE:
      if (db_str_to_date (peek_left, peek_right, peek_third,
			  arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
      ...
      else
	{
	  ...
	  peek_third =
	    db_value_cast_arg (peek_third, &tmp_third, DB_TYPE_INTEGER,
			       &error_status);
    ...
    case T_HA_STATUS:
      db_make_string (arithptr->value,
		      logtb_find_current_ha_status (thread_p));
      break;

    case T_SHARD_GROUPID:
      db_make_int (arithptr->value,
		   logtb_find_current_shard_groupid (thread_p));
      break;

    case T_SHARD_LOCKNAME:
      db_make_string (arithptr->value,
		      logtb_find_current_shard_lockname (thread_p));
      break;
    ...
    case T_TO_CHAR:
      if (db_to_char (peek_left, peek_right, peek_third,
		      arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_TO_DATE:
      if (db_to_date (peek_left, peek_right, peek_third,
		      arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
    ...
    case T_TO_TIME:
      if (db_to_time (peek_left, peek_right, peek_third,
		      arithptr->value) != NO_ERROR)
	{
	  goto error;
	}
	...
	switch (ev_res)
	  ...
	  case V_UNKNOWN:	/* unknown pred result, including cases of NULL pred operands */
	    ...
	    dom_status =
	      tp_value_coerce (peek_right, arithptr->value, target_domain);
	    if (dom_status != DOMAIN_COMPATIBLE)
	      {
	...
	if (tp_value_coerce (src,
			     arithptr->value,
			     target_domain) != DOMAIN_COMPATIBLE)
	  {
	    er_set (ER_ERROR_SEVERITY, ARG_FILE_LINE, ER_TP_CANT_COERCE, 2,
	...
	if (DB_IS_NULL (peek_left))
	  {
		...
		||
		TP_IS_FLOATING_NUMBER_TYPE (DB_VALUE_DOMAIN_TYPE
					    (peek_right)))
	      {
	...
	if (tp_value_coerce (src, arithptr->value, target_domain) !=
	    DOMAIN_COMPATIBLE)
	  {
	    er_set (ER_ERROR_SEVERITY, ARG_FILE_LINE, ER_TP_CANT_COERCE, 2,
		    pr_type_name (DB_VALUE_DOMAIN_TYPE (src)),
	...
	{
	  if (tp_value_coerce (peek_left, arithptr->value,
			       target_domain) != DOMAIN_COMPATIBLE)
	    {
	      er_set (ER_ERROR_SEVERITY, ARG_FILE_LINE, ER_TP_CANT_COERCE, 2,
      ...
      if (arithptr->rightptr != NULL)
	{
	  if (DB_IS_NULL (peek_left) && DB_IS_NULL (peek_right))
	    ...
	    {
	      if (tp_value_coerce (peek_right, arithptr->value,
				   target_domain) != DOMAIN_COMPATIBLE)
		{
		  er_set (ER_ERROR_SEVERITY, ARG_FILE_LINE, ER_TP_CANT_COERCE,
			  2, pr_type_name (DB_VALUE_DOMAIN_TYPE (peek_right)),
      ...
      if (REGU_VARIABLE_IS_FLAGED (regu_var, REGU_VARIABLE_FIELD_COMPARE))
	{
	   ...
	   */
	  peek_left =
	    db_value_cast_arg (peek_left, &tmp_left, DB_TYPE_VARCHAR,
			       &error_status);
	  peek_right =
	    db_value_cast_arg (peek_right, &tmp_right, DB_TYPE_VARCHAR,
			       &error_status);
	  peek_third =
	    db_value_cast_arg (peek_third, &tmp_third, DB_TYPE_VARCHAR,
			       &error_status);
      ...
      else
	{
	   ...
	   */
	  peek_left =
	    db_value_cast_arg (peek_left, &tmp_left, DB_TYPE_INTEGER,
			       &error_status);
	...
	peek_right =
	  db_value_cast_arg (peek_right, &tmp_right, DB_TYPE_INTEGER,
			     &error_status);
      ...
      else
	{
	  if (!arithptr->thirdptr)
				       ...
				       &tmp_len, &tmp_val) != NO_ERROR)
		{
	      ...
	      assert (DB_IS_NULL (&tmp_val)
		      || DB_VALUE_DOMAIN_TYPE (&tmp_val) == DB_TYPE_VARCHAR);
      ...
      else
	{
	  ...
	  peek_left =
	    db_value_cast_arg (peek_left, &tmp_right, DB_TYPE_VARCHAR,
			       &error_status);
	  peek_right =
	    db_value_cast_arg (peek_right, &tmp_right, DB_TYPE_INTEGER,
			       &error_status);
	...
	else if (tp_value_coerce (peek_left, arithptr->value, target_domain)
		 != DOMAIN_COMPATIBLE)
	  {
	    er_set (ER_ERROR_SEVERITY, ARG_FILE_LINE, ER_TP_CANT_COERCE, 2,
		    pr_type_name (DB_VALUE_DOMAIN_TYPE (peek_left)),
	...
	if (tp_value_coerce (arithptr->value, arithptr->value, target_domain)
	    != DOMAIN_COMPATIBLE)
	  {
	    er_set (ER_ERROR_SEVERITY, ARG_FILE_LINE, ER_TP_CANT_COERCE, 2,
      ...
      else
	{
	  ...
	  if (arithptr->rightptr->type == TYPE_CONSTANT
	      ...
	      if (arithptr->rand_seed == NULL)
		{
		  ...
		  srand48_r ((long) DB_GET_INTEGER (peek_right),
			     arithptr->rand_seed);
		}
      ...
      else
	{
	  ...
	  if (!TP_IS_NUMERIC_TYPE (DB_VALUE_DOMAIN_TYPE (peek_right)))
	    {
	      peek_right =
		db_value_cast_arg (peek_right, &tmp_right, DB_TYPE_DOUBLE,
				   &error_status);
	  ...
	  switch (db_value_type (peek_right))
	    ...
	    case DB_TYPE_NUMERIC:	/* TODO - */
	      {
		DB_BIGINT bint;
		numeric_coerce_num_to_bigint (db_locate_numeric (peek_right),
					      DB_VALUE_SCALE (peek_right),
					      &bint);
      ...
      if (error_status != NO_ERROR)
	{
      ...
      if (qdata_get_index_cardinality (thread_p, peek_left, peek_right,
				       peek_third,
				       arithptr->value) != NO_ERROR)
	{
	  goto error;
...
fetch_peek_dbval_pos (REGU_VARIABLE * regu_var, QFILE_TUPLE tpl,
		      int pos, TP_DOMAIN * pos_domain,
		      DB_VALUE ** peek_dbval, QFILE_TUPLE * next_tpl)
{
  int length;
  PR_TYPE *pr_type;
  OR_BUF buf;
  ...
  *peek_dbval = regu_var->vfetch_to;
  ...
  if (qfile_locate_tuple_value_r (tpl, pos, &ptr, &length) == V_BOUND)
      ...
      if (pr_type == NULL || pr_type->id == DB_TYPE_VARIABLE)
	{
      ...
      if ((*(pr_type->data_readval)) (&buf, *peek_dbval, pos_domain, -1,
				      false /* Don't copy */ ) != NO_ERROR)
	{
	  return ER_FAILED;
	}
    }
					       ...
					       DB_VALUE ** max)
{
  ...
  er_status = fetch_peek_dbval (thread_p, eval_term1->et.et_comp.comp_rhs,
				vd, obj_oid, tpl, min);
  ...
  er_status = fetch_peek_dbval (thread_p, eval_term2->et.et_comp.comp_rhs,
				vd, obj_oid, tpl, max);
  if (er_status != NO_ERROR)
    {
      if (er_errid () == NO_ERROR)
		  ...
		  QFILE_TUPLE tpl, DB_VALUE * dbval)
{
  ...
  result = fetch_peek_dbval (thread_p, regu_var, vd, obj_oid, tpl,
			     &readonly_val);
  if (result != NO_ERROR)
    {
      return result;
...
fetch_val_list (THREAD_ENTRY * thread_p, REGU_VARIABLE_LIST regu_list,
		VAL_DESCR * vd, OID * obj_oid,
		QFILE_TUPLE tpl, QFILE_TUPLE_VALUE_TYPE_LIST * tpl_type_list,
		int peek)
{
      ...
      for (regup = regu_list; regup != NULL; regup = regup->next)
	{
	  if (regup->value.type == TYPE_POSITION)
	      ...
	      else
		{
	      ...
	      rc = fetch_peek_dbval_pos (&regup->value, next_tpl,
					 pos, pos_domain, &peek_val,
					 &next_tpl);
	    }
	  else
	    {
		  ...
		  (DB_VALUE_DOMAIN_TYPE (regup->value.vfetch_to)))
		{
	      ...
	      rc = fetch_peek_dbval (thread_p, &regup->value, vd,
				     obj_oid, tpl, &peek_val);
	    }
