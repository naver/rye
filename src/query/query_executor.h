...
extern XASL_CACHE_ENTRY *qexec_update_xasl_cache_ent (THREAD_ENTRY * thread_p,
                                                      ...
                                                      const OID * oid,
                                                      int n_oids,
                                                      const OID * class_oids, const int *repr_ids, int dbval_cnt);
...
extern XASL_CACHE_ENTRY *qexec_check_xasl_cache_ent_by_xasl (THREAD_ENTRY *
                                                             ...
                                                             const XASL_ID *
                                                             xasl_id,
                                                             int dbval_cnt, XASL_CACHE_CLONE ** clop, bool save_clop);
...
extern int stx_map_stream_to_xasl (THREAD_ENTRY * thread_p,
                                   XASL_NODE ** xasl_tree, char *xasl_stream, int xasl_stream_size);
...
extern int qexec_get_tuple_column_value (QFILE_TUPLE tpl, int index, TP_DOMAIN * index_domain, DB_VALUE * valp);
#if defined (ENABLE_UNUSED_FUNCTION)
...
extern int qexec_update_index_stats (THREAD_ENTRY * thread_p, CIRP_CT_INDEX_STATS * index_stats);
extern int qexec_upsert_applier_info (THREAD_ENTRY * thread_p, DB_IDXKEY * pk, CIRP_CT_LOG_APPLIER * applier);
#if defined (ENABLE_UNUSED_FUNCTION)
extern int qexec_update_applier_info (THREAD_ENTRY * thread_p, DB_IDXKEY * pk, CIRP_CT_LOG_APPLIER * applier_info);
extern int qexec_update_analyzer_info (THREAD_ENTRY * thread_p, DB_IDXKEY * pk, CIRP_CT_LOG_ANALYZER * analyzer);
#endif
extern int qexec_upsert_analyzer_info (THREAD_ENTRY * thread_p, DB_IDXKEY * pk, CIRP_CT_LOG_ANALYZER * analyzer);
